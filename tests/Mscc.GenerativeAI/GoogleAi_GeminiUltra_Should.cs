...
namespace Test.Mscc.GenerativeAI
{
    ...
    public class GoogleAi_GeminiUltra_Should
    {
        private readonly ITestOutputHelper output;
        private readonly ConfigurationFixture fixture;
        private readonly string model = Model.GeminiUltra;

        public GoogleAi_GeminiUltra_Should(ITestOutputHelper output, ConfigurationFixture fixture)
        {
            this.output = output;
