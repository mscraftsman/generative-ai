...
namespace GeminiApiConsole;

public abstract class GeminiConsole(GenerativeModel client)
{
	...
	public GenerativeModel Client { get; } = client ?? throw new ArgumentNullException(nameof(client));
